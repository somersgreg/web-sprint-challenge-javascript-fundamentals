...
console.log(displayNames);  // (10) ["Name: Jackal..."]
...
console.log(lowCaseAnimalNames);  // (10) ["Name: jackal..."]
...
console.log(lowPopulationAnimals);  // (3) [Screamer....]
...
*/
let populationTotal = zooAnimals.reduce(((acc, count) => acc += count.population), 0);
